...
| B4 | API | `apps/api` Fastify: REST (tablero, proyectos, agentes, runs, approvals, contexto), login simple, WS multiplexado con since_seq, canal `web` con dedup, despachador determinista + recuperación al boot | GP | B2,B3 | 🔨 en curso |
