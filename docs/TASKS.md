...
| B6 | MCP admin | `apps/mcp-admin`: perfiles rw/ro, ~35 tools sobre packages/core, idempotency+expected_version+audit; registro en Claude Code de Ernesto | GP | B3 | 🔨 en curso |
