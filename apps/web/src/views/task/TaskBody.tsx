...
function ProjectContextSection({ sources, documents, onNavigate }: {
  ...
  return (
    <section className="mt-5" aria-labelledby="task-context-title">
      <div className="flex items-center justify-between gap-2">
        ...
        <Link to="/context" onClick={onNavigate} className="text-label font-semibold text-link underline underline-offset-2">abrir contexto</Link>
      </div>
...
export function TaskBody() {
  ...
  return (
    <>
      ...
      <ProjectContextSection sources={sources} documents={documents} onNavigate={closeTask} />
