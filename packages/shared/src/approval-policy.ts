 ...
 *
 * Vive en @agentos/shared (mudada desde packages/core/src/board/policy.ts en §13.3):
 * es 100% pura (cero imports) y el motor de launch de @agentos/db la necesita sin
 * crear el ciclo db → core → db. El barrel de core la RE-exporta — su API no cambia.
 *
