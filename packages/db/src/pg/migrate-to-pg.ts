...
export const TABLE_PAIRS: TablePair[] = [
  ...
  { name: "org_units", from: lite.orgUnits, to: pg.orgUnits, pk: "id", orderBy: "created_at" },
  { name: "org_roles", from: lite.orgRoles, to: pg.orgRoles, pk: "id", orderBy: "created_at" },
  { name: "role_functions", from: lite.roleFunctions, to: pg.roleFunctions, pk: "id", orderBy: "created_at" },
  { name: "role_people", from: lite.rolePeople, to: pg.rolePeople, pk: ["role_id", "person_id"], orderBy: "created_at" },
  { name: "role_processes", from: lite.roleProcesses, to: pg.roleProcesses, pk: ["role_id", "process_id"], orderBy: "created_at" },
