...
export function listTaskLabels(db: AgentosSqliteDb, taskId: string): string[] {
  return db
...
export function listLabelsForTasks(db: AgentosSqliteDb, taskIds: readonly string[]): Map<string, string[]> {
...
export function removeTaskLabel(db: AgentosSqliteDb, taskId: string, label: string): string[] {
...
export function listTaskLabelRows(db: AgentosSqliteDb, taskId: string): TaskLabel[] {
  return db
    .select()
    .from(taskLabels)
    .where(eq(taskLabels.taskId, taskId))
